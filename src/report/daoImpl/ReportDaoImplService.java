 ...
 * 
 */
@WebServiceClient(name = "ReportDaoImplService", targetNamespace = "http://daoImpl.report/", wsdlLocation = "http://localhost:5000/soap/ventas/reporte?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTDAOIMPLSERVICE_QNAME = new QName("http://daoImpl.report/", "ReportDaoImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:5000/soap/ventas/reporte?wsdl");
    ...
    public ReportDao getReportDaoImplPort() {
        return super.getPort(new QName("http://daoImpl.report/", "ReportDaoImplPort"), ReportDao.class);
    }
    ...
    public ReportDao getReportDaoImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://daoImpl.report/", "ReportDaoImplPort"), ReportDao.class, features);
    }
